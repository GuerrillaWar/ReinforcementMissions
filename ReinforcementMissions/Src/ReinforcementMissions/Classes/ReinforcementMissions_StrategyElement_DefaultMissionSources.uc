class ReinforcementMissions_StrategyElement_DefaultMissionSources extends X2StrategyElement_DefaultMissionSources config(GameData);

// These templates must be overwritten to use the OneStrategyObjectiveCompleted function for success, otherwise
// you'll always fail the mission when you Evac.
