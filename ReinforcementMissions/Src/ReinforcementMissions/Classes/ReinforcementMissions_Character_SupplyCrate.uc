...
class ReinforcementMissions_Character_SupplyCrate extends X2Character;
...
static function X2CharacterTemplate CreateTemplate_SupplyCrate()
{
	...
	CharTemplate.BehaviorClass = class'ReinforcementMissions_AIBehavior_SupplyCrate';

	CharTemplate.strPawnArchetypes.AddItem("ReinforcementMissions_SupplyRaidExtract.ReinforcementMissions_GameUnit_SupplyCrate");
	...
	CharTemplate.Abilities.AddItem('ReinforcementMissions_AlwaysUnconscious');
